                ...
                html.Div(
                    ...
                    children=[
                        ...
                        card([
                            ...
                            html.Label("Referencia de potencia [W]",
                                       style={"fontSize": "11px",
                                              "color":    C["label"],
                                              "display":  "block",
                                              "marginBottom": "8px"}),
...
def _panel_variables(med, estados):
    ...
    sp   = estados.get("setpoint_potencia_w", 0)
    ...
    return html.Div([
        ...
        _fila_variable("Setpoint",       f"{sp:.1f} W",    C["blue"]),
    ])
...
def cb_setpoint(n_clicks, valor):
    if valor is None:
        return "⚠ Ingresa un valor entre 0 y 15000 W."
    try:
